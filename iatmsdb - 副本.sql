...
CREATE TABLE `projectmembers`  (
  ...
  `assigned_tasks` int NULL DEFAULT 0 COMMENT '分配任务数',
...
CREATE TABLE `projects`  (
  ...
  `creator_id` int NOT NULL COMMENT '创建人ID，关联用户表',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `is_deleted` tinyint(1) NULL DEFAULT 0 COMMENT '是否删除',
  `deleted_at` timestamp NULL DEFAULT NULL COMMENT '删除时间',
  ...
  UNIQUE INDEX `project_code_2`(`project_code` ASC) USING BTREE,
...
CREATE TABLE `scheduledtesttasks`  (
  ...
  `successful_executions` int NULL DEFAULT 0 COMMENT '成功执行次数',
  `failed_executions` int NULL DEFAULT 0 COMMENT '失败执行次数',
  `skipped_executions` int NULL DEFAULT 0 COMMENT '跳过执行次数',
  ...
  `last_execution_status` enum('pending','running','success','failed','skipped') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '最后执行状态',
...
CREATE TABLE `tasks`  (
  ...
  `assignee_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '被分配人姓名',
  `assigner_id` int NULL DEFAULT NULL COMMENT '分配人ID',
  `assigner_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '分配人姓名',
  `project_id` int NULL DEFAULT NULL COMMENT '关联项目ID',
  `project_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '关联项目名称',
...
CREATE TABLE `testcaseresults`  (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL COMMENT '删除时间',
  `deleted_by` int NULL DEFAULT NULL COMMENT '删除人ID',
  `case_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '用例编码',
  `case_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '用例名称',
  ...
  `suite_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '测试套件名称',
  `package_name` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '包名/命名空间',
  `epic_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT 'Epic名称',
  `feature_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT 'Feature名称',
  `story_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT 'Story名称',
  ...
  INDEX `idx_suite_name`(`suite_name` ASC) USING BTREE,
  INDEX `idx_package_name`(`package_name`(100) ASC) USING BTREE,
  INDEX `idx_epic_name`(`epic_name` ASC) USING BTREE,
...
CREATE TABLE `testexecutionrecords`  (
  ...
  `total_cases` int NULL DEFAULT 0 COMMENT '总用例数',
  `executed_cases` int NULL DEFAULT 0 COMMENT '已执行用例数',
  `passed_cases` int NULL DEFAULT 0 COMMENT '通过用例数',
  `failed_cases` int NULL DEFAULT 0 COMMENT '失败用例数',
  `skipped_cases` int NULL DEFAULT 0 COMMENT '跳过用例数',
  `success_rate` decimal(5, 2) NULL DEFAULT 0.00 COMMENT '成功率',
...
CREATE TABLE `users`  (
  ...
  `creator_id` int NULL DEFAULT NULL COMMENT '创建人ID，关联用户表',
